...

{
	...
	system(skCrypt("start https://discord.gg/pj75ee3fxj"));
	...
	std::cout << "Make Sure you joined the OFFICIAL Community Cord discord!\n";
...
void render() {
	...
	if (ShowMenu)
	{
		...
		ImGui::Begin(("COMM CORD Free FN |  " __DATE__  __TIME__), 0, ImGuiWindowFlags_NoCollapse | ImGuiWindowFlags_NoResize | ImGuiWindowFlags_NoScrollbar);
